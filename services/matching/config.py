"""
Matching service configuration using environment variables.
...
class Settings(BaseSettings):
    """
    Matching service settings loaded from environment variables.
...
def get_settings() -> Settings:
    ...
    if _settings is None:
        _settings = Settings()
        logger.info(f"Loaded matching service configuration (log_level={_settings.log_level})")
    return _settings
