"""
Сопоставитель векторной похожести с использованием sentence-transformers.

# Русский комментарий:
Этот модуль предоставляет семантическое сопоставление похожести между резюме
и вакансиями с использованием предложений из библиотеки sentence-transformers.

Основные возможности:
- Семантическое сходство за пределами сопоставления ключевых слов
- Сопоставление с учетом контекста (например, "JS developer" ≈ "JavaScript programmer")
- Оценка косинусного сходства
- Кэширование загрузки модели для производительности
"""
import logging
