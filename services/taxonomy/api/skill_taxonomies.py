"""
Эндпоинты управления таксономией навыков.

# Русский комментарий:
Этот модуль предоставляет эндпоинты для управления отраслевыми таксономиями навыков,
включая CRUD-операции для создания, чтения, обновления и удаления записей таксономии
...
async def load_it_taxonomy(
    ...
    taxonomy_path = Path(__file__).parent.parent.parent / "backend" / "data" / "industry_taxonomies" / "it_taxonomy.json"
