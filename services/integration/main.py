...
# Русский комментарий:
Приложение FastAPI для Integration Service.
...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    logger.info(f"Database schema: {settings.integration_db_schema}")
...
app = FastAPI(
    ...
    description="Service for managing external API integrations / Сервис для управления интеграциями с внешними API",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
...
async def health_check() -> JSONResponse:
    ...
    Example:
        ...
        {"status":"healthy","service":"integration-service","version":"1.0.0"}
    """
    return JSONResponse(
...
async def readiness_check() -> JSONResponse:
    ...
    # TODO: Add external API availability checks / Добавить проверку доступности внешних API
