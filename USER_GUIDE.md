...
**Your Complete Guide to Hiring Smarter with AI**

Welcome! This guide is written specifically for HR recruiters and hiring managers who want to use AgentHR to find, evaluate, and hire the best candidates faster. No technical background required—we explain everything in plain language.
...
2. [Posting Job Vacancies](#posting-job-vacancies)
   - [Creating Your First Job Posting](#creating-your-first-job-posting)
   - [Required Fields and Best Practices](#required-fields-and-best-practices)
   - [Managing Multiple Vacancies](#managing-multiple-vacancies)
...
4. [Understanding AI Match Scores](#understanding-ai-match-scores)
   - [What is a Match Score?](#what-is-a-match-score)
   - [How the Three Matching Methods Work](#how-the-three-matching-methods-work)
   - [Interpreting Your Match Results](#interpreting-your-match-results)
   - [Tips for Better Matching](#tips-for-better-matching)

5. [Candidate Ranking and Recommendations](#candidate-ranking-and-recommendations)
   - [What is AI Ranking?](#what-is-ai-ranking)
   - [Understanding Recommendation Levels](#understanding-recommendation-levels)
   - [The 13 Factors That Influence Rankings](#the-13-factors-that-influence-rankings)
   - [Using Feature Importance to Understand Scores](#using-feature-importance-to-understand-scores)

6. [Using the Kanban Board](#using-the-kanban-board)
   - [Board Overview and Columns](#board-overview-and-columns)
   - [Moving Candidates Through Stages](#moving-candidates-through-stages)
   - [Adding Notes and Tags](#adding-notes-and-tags)
   - [Best Practices for Pipeline Management](#best-practices-for-pipeline-management)

7. [Providing Feedback on Rankings](#providing-feedback-on-rankings)
   - [Why Your Feedback Matters](#why-your-feedback-matters)
   - [How to Submit Feedback](#how-to-submit-feedback)
   - [What Happens With Your Feedback](#what-happens-with-your-feedback)

8. [Analytics Dashboard](#analytics-dashboard)
   - [Key Metrics Explained](#key-metrics-explained)
   - [Understanding Your Recruitment Funnel](#understanding-your-recruitment-funnel)
   - [Time-to-Hire and Other Performance Metrics](#time-to-hire-and-other-performance-metrics)
   - [Using Data to Improve Hiring](#using-data-to-improve-hiring)

9. [Advanced Search and Filtering](#advanced-search-and-filtering)
   - [Basic Search](#basic-search)
   - [Using Filters Effectively](#using-filters-effectively)
   - [Saving and Reusing Searches](#saving-and-reusing-searches)
   - [Search Examples and Tips](#search-examples-and-tips)

10. [Comparing Candidates Side-by-Side](#comparing-candidates-side-by-side)
    - [Creating a Candidate Comparison](#creating-a-candidate-comparison)
    - [Understanding the Comparison View](#understanding-the-comparison-view)
    - [Exporting Comparison Results](#exporting-comparison-results)

11. [Frequently Asked Questions](#frequently-asked-questions)
    - [Understanding the AI](#understanding-the-ai)
    - [Resumes and Matching](#resumes-and-matching)
    - [Rankings and Scores](#rankings-and-scores)
    - [Account and Settings](#account-and-settings)
    - [Troubleshooting Common Issues](#troubleshooting-common-issues)

12. [Troubleshooting](#troubleshooting)
    - [Resume Upload Issues](#resume-upload-issues)
    - [Analysis Taking Too Long](#analysis-taking-too-long)
    - [Match Scores Seem Wrong](#match-scores-seem-wrong)
    - [Can't Find Candidates](#cant-find-candidates)
    - [Contacting Support](#contacting-support)

13. [Glossary of Terms](#glossary-of-terms)
    - [A-I Terms](#a-i-terms)
    - [Recruitment Terms](#recruitment-terms)
    - [Platform-Specific Terms](#platform-specific-terms)
...
This guide is written for **HR recruiters and hiring managers** at small-to-medium businesses who need to evaluate candidates efficiently and make better hiring decisions. Whether you're hiring one person or building an entire team, AgentHR helps you:

- **Save time** by automatically screening resumes
- **Find better matches** with AI-powered candidate ranking
- **Make informed decisions** with clear, explainable recommendations
- **Stay organized** with visual pipeline management
- **Collaborate effectively** with your hiring team

### What Is AgentHR?

AgentHR is an **AI-powered hiring platform** that helps you evaluate candidates faster and more accurately. Here's what it does:

#### **Resume Analysis**
Upload resumes in PDF or DOCX format, and AgentHR automatically extracts:
- Contact information
- Work experience
- Education history
...
#### **Smart Matching**
Compare candidates to your job openings using three intelligent methods:
- **Keyword Matching** – Finds exact skill matches
- **TF-IDF Matching** – Weights important skills more heavily
- **Vector Similarity** – Understands context and meaning (e.g., knows that "JS" and "JavaScript" are the same thing)

#### **AI-Powered Ranking**
Get ranked candidate lists based on 13 factors, including:
- Skills match ratio
- Experience relevance
- Education level
- Resume completeness
- And 9 more data-driven factors

#### **Recommendation Levels**
Each candidate receives a clear recommendation:
- **Excellent** (≥80%) – Top candidate, highly recommended
- **Good** (60-79%) – Strong match, recommend interview
- **Maybe** (40-59%) – Potential match, review needed
- **Poor** (<40%) – Not a match

#### **Visual Pipeline Management**
Track all candidates through your hiring process with a Kanban board:
- Applied → Screening → Interview → Offer → Hired (or Rejected)

#### **Continuous Improvement**
The more you use AgentHR and provide feedback, the smarter it gets. Your feedback helps improve recommendations for future hires.

### What Makes AgentHR Different?

| Traditional Hiring | AgentHR |
|-------------------|---------|
| Manually review every resume | AI ranks candidates automatically |
| Subjective screening | Data-driven, explainable rankings |
| Hours spent on unqualified candidates | Focus on top-rated candidates |
| Gut-feeling decisions | Clear scores with 13 contributing factors |
| No visibility into what works | Analytics show what's working |

### How This Guide Is Organized

This guide follows the **natural hiring workflow**:

1. **Get started** – Access the platform and learn the basics
2. **Post jobs** – Create job vacancies with clear requirements
3. **Upload resumes** – Add candidate resumes to the system
4. **Understand scores** – Learn how match scores and rankings work
5. **Evaluate candidates** – Use rankings and comparisons to shortlist
6. **Manage pipeline** – Track candidates through the hiring process
7. **Provide feedback** – Help the AI learn and improve
8. **Analyze results** – Use analytics to optimize your hiring

### Before You Begin

To get the most out of AgentHR, you'll need:

- **Job vacancies** – Clear descriptions of roles you're hiring for
- **Resumes** – Candidate resumes in PDF or DOCX format
- **Time to review** – While AI speeds up screening, you'll still want to review top candidates personally
- **Willingness to provide feedback** – Your input makes the system smarter

### Tips for Success

Here are some best practices before we dive in:

✅ **Be specific in job descriptions** – Detailed requirements lead to better matches

✅ **Upload resumes in batches** – Process multiple candidates at once for efficiency

✅ **Trust but verify** – Use AI rankings as a tool, not a replacement for human judgment

✅ **Provide feedback** – Tell AgentHR when recommendations are helpful (or not)

✅ **Use the Kanban board** – Keep your pipeline organized and visible

✅ **Review feature importance** – Understand which factors are driving rankings

### Getting Help

If you get stuck at any point:

- Check the [FAQ](#frequently-asked-questions) for quick answers
- Review the [Troubleshooting](#troubleshooting) section for common issues
- Look up unfamiliar terms in the [Glossary](#glossary-of-terms)
